...
%\item Lukasz Ziarek:
%{\bf PRP: priority rollback protocol -- a PIP extension for mixed criticality systems: short paper}
%In \emph{International Workshop on Java Technologies for Real-Time and Embedded Systems} 2010.
